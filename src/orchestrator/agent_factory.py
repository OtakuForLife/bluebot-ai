...
class AgentFactory:
    ...
    def update_llm_provider(self, llm_provider: BaseLLMProvider) -> None:
        ...
        """
        self.logger.info("Updating LLM provider for all agents...")
